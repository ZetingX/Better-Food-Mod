...
public class BreadPieceItem extends ZxbfmModElements.ModElement {
	@ObjectHolder("zxbfm:bread_piece")
	public static final Item block = null;
	public BreadPieceItem(ZxbfmModElements instance) {
		super(instance, 11);
	}
