...
public class HoneyJarItem extends ZxbfmModElements.ModElement {
	@ObjectHolder("zxbfm:honey_jar")
	public static final Item block = null;
	public HoneyJarItem(ZxbfmModElements instance) {
		super(instance, 26);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			ItemStack retval = new ItemStack(JarItem.block, (int) (1));
