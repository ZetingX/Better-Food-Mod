...
public class BoiledEggItem extends ZxbfmModElements.ModElement {
	@ObjectHolder("zxbfm:boiled_egg")
	public static final Item block = null;
	public BoiledEggItem(ZxbfmModElements instance) {
		super(instance, 5);
	}
