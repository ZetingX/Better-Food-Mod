...
public class TomatoPlantBlock extends ZxbfmModElements.ModElement {
	@ObjectHolder("zxbfm:tomato_plant")
	public static final Block block = null;
	public TomatoPlantBlock(ZxbfmModElements instance) {
		super(instance, 38);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TomatoItem.block, (int) (1)));
		}
